...
\begin{figure}[h]
  \begin{center}
    \vspace{3mm}
    \includegraphics[scale=0.6]{../Img/Survival.png}
  \end{center} 
...
\begin{itemize}
\item Les DFE considérées sont discontinues en 0 et donc leur transformée de Fourier décroît lentement vers 0 quand $\xi\to\infty$: voir la figure \ref{fig:DFE_fourier}. Comme nous sommes contraints de rogner la transformée de Fourier, nous perdons beaucoup d'information;
