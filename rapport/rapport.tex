...
d'où :
  \begin{align*}
	...
	& = \frac{\varepsilon}{\pi}\times\frac{2\pi d_k e^{o(1)}}{k^k\varepsilon\pth{\ln\pth{\frac{1}{k}}+\frac1k\ln\pth{\frac{2\pi d_k}{\varepsilon}}}^k} - \frac{\varepsilon}{\pi}\\
	...
	& \text{or } e^{o(1)}\to1 \text{ et } \ln\ln(x)=o(ln(x)) \text{ quand } x\to+\infty\\
	& = \frac{2 d_k}{\pth{k\ln\pth{\frac{1}{k}}+\ln\pth{\frac{2\pi d_k}{\varepsilon}}}^k} + \frac{2d_k}{\pth{k\ln\pth{\frac{1}{k}}+\ln\pth{\frac{2\pi d_k}{\varepsilon}}}^{k-1}} + o(1)\\
	& \text{or } x^{k-1}=o(x^k) \text{ quand } x\to+\infty\\
...
\[\alpha(A_\varepsilon)\sim \abs{\frac{2 d_k}{\ln^k\pth{\varepsilon}}}\]
